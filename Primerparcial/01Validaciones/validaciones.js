/*
las validaciones para éste formulario 
se realizarán  mediante el uso de Expresiones 
Regulares,las cuales las vamos a dividir en 3:
1.-Texto para el nombre 
2.-Numércio para la boleta 
3.-Debe de tenjer un patrón para la fecha 
...
const patrones = {
    nombre : /^[A-Za-zAÉÍÓÚÑáéíóúñü\s]{2,60}$/,
    boleta : /^\d{10}$/,
...
//Para validar el formulario debemos ocupar los rincipios de obtención y manipulacuón de los elemntos del DOM
